                    ...
                    >
                        <ul>
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.tiktok.com/@diablo"
                                    data-auto-id="true"
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.instagram.com/diablo"
                                    data-auto-id="true"
                                    id="page-footer-http-www-instagram-com-bellroy-1"
                                >
                                    <svg
